...
# appFlags:
# 0x200 APPLICATION_FLAG_BOLOS_SETTINGS
# 0x040 APPLICATION_FLAG_GLOBAL_PIN

APP_LOAD_PARAMS =--appFlags 0x240 --curve ed25519 --path "44'/540'"
...
## USB U2F
DEFINES += HAVE_U2F HAVE_IO_U2F U2F_PROXY_MAGIC=\"SMESH\" USB_SEGMENT_SIZE=64 
