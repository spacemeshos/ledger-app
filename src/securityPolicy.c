...
static inline bool has_spacemesh_prefix_and_any_account(const bip44_path_t* pathSpec)
{
	return bip44_hasValidSpacemeshPrefix(pathSpec) &&
...
{
	DENY_IF(!has_spacemesh_prefix_and_any_account(pathSpec));
